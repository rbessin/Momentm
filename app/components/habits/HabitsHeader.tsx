...
export default function HabitsHeader(props: {
    ...
    const { view, setView, currentDate, setCurrentDate, getPreviousDateRange, getNextDateRange, dates } = props;

    return (
    <div className="flex flex-col bg-white rounded-xl shadow-md p-4 md:flex-row md:items-center md:justify-between mb-6">
      <h1 className="text-3xl text-indigo-500 font-bold mb-4 md:mb-0">Habits</h1>
